      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_11___default.a.get('http://localhost:3000/api/75057168493');

            case 2:
              response = _context.sent;
              console.log(response); // const response = await axios.put('https://bismuth-dev.myshopify.com/admin/api/2019-07/themes/75057168493/assets.json', { asset: {key: "templates/index.liquid", value: "test"} })
...
//# sourceMappingURL=annotated-layout.js.2bf7ac2028f6d38e298c.hot-update.js.map